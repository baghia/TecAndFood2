<header>
    ...
    <nav>
        <div class="nav-wrapper">
            ...
            <a href="../../home.jsp" class="brand-logo hide-on-med-and-down"><h5>Tec And Food - Bem-Vindo(a), <%= usuario.getNome()%></h5></a>
    ...
    <ul id="nav-mobile" class="side-nav fixed hide-on-med-and-up" style="width: 240px;">
        ...
        <li class="bold"><a href="../relatorio/" class="waves-effect waves-teal">Relatórios</a></li>
